        ...
        if (mTwoPane) {
            ...
            switch (bodyPartNumber) {
                case 0:
                    ...
                    newFragment.setImagesIds(AndroidImageAssets.getHeads());
                    ...
                    break;
                case 1:
                    newFragment.setImagesIds(AndroidImageAssets.getBodies());
                    newFragment.setListIndex(listIndex);
                    getSupportFragmentManager().beginTransaction()
                    ...
                    break;
                case 2:
                    newFragment.setImagesIds(AndroidImageAssets.getLegs());
                    newFragment.setListIndex(listIndex);
                    getSupportFragmentManager().beginTransaction()
